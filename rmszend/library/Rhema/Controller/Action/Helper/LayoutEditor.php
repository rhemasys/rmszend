 ...
 *
 */
class Rhema_Controller_Action_Helper_LayoutEditor  extends Rhema_Controller_Action_Helper_Abstract{
		...
		$view		     = Zend_Layout::getMvcInstance()->getView();
     	...
     	$ecomRoots	     = $oMenu->getRoots('ecom_navigation_menu');
      	...
      	$result = array('items' =>	array(
			     		...
			     		'types'  => $mService->factory('admin_content_type')->getContentTypes() ,
